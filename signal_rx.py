...
# Title: Signal Rx
# Generated: Wed Sep 23 18:03:17 2020
##################################################
...
class signal_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Signal Rx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Signal Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_rx")
        ...
        self.center_freq = center_freq = 2672e6
        self.bandwidth = bandwidth = 1e6

        ##################################################
        # Blocks
        ##################################################
        self._center_freq_range = Range(2671.9e6, 2672.1e6, 1e-3, 2672e6, 200)
...
def main(top_block_cls=signal_rx, options=None):
